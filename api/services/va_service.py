...
class VAService:
    ...
    async def get_va_facilities_by_state(
        self, state_code: str, facility_type: str = "health"
    ) -> List[Dict[str, Any]]:
        """
        ...
        try:
            ...
            logger.info(
                f"Fetched {len(va_facilities)} VA facilities for state {state_code}"
            )
        ...
        try:
            ...
            return {
                ...
                "address": {
                    ...
                    .get("physical", {})
                    .get("address_1", ""),
                    "city": attributes.get("address", {})
                    .get("physical", {})
                    .get("city", ""),
                    "state": attributes.get("address", {})
                    .get("physical", {})
                    .get("state", ""),
                    "zip_code": attributes.get("address", {})
                    .get("physical", {})
                    .get("zip", ""),
                    "county": attributes.get("address", {})
                    .get("physical", {})
                    .get("county", ""),
                },
                "contact": {
                ...
                "accessibility": {
                    ...
                    "public_transit": attributes.get("access", {}).get(
    ...
    async def get_va_facility_details(
