...
/**
 * Get MaterialCommunityIcons vector icon name for a utility type.
 * Used by map markers for crisp, scalable rendering.
 * @param type - Utility type or category
 * @returns Object with icon name for MaterialCommunityIcons
 */
